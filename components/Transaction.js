...
const Transaction = ({ item }) => {
	...
	return (
		<div className="flex flex-col border-[#d6d7d9] border-2 rounded-lg shadow-lg">
			<div className="flex w-full h-[80px] bg-[#f0f1f3] p-[20px] pr-[80px] gap-[80px]">
				<div className="flex w-full gap-[80px]">
					<div className="text-sm text-left flex items-center">
						ORDER PLACED <br />
						{moment(item.purchaseDate).format("MMMM Do YYYY")}
					</div>
					<div className="text-sm text-left flex items-center">
						TOTAL <br />
						{item.price} AC
			...
			<div className="flex flex-col w-full h-[400px] gap-[20px] p-[20px] flex-1">
				<div className="text-xl font-bold">
					Bought on {moment(item.purchaseDate).format("MMMM Do")}
				</div>
				<div className="flex flex-row gap-[20px] w-full">
					...
					<div className="flex flex-col justify-end">
						<div className="text-md font-bold flex ml-[10px]">{item.name}</div>
